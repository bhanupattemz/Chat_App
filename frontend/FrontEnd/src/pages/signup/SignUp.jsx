			...
			<div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
				...
				<form onSubmit={handleSubmit}>
                    ...
                    <div>
						...
						<input type='email' placeholder='email' className='w-full input input-bordered h-10'  value={inputs.email} onChange={(e)=>{setInputs({...inputs,email:e.target.value})}}/>
					</div>
					...
					<Link className='text-sm hover:underline hover:text-blue-600 mt-2 inline-block  text-gray-300' to='/login' >
